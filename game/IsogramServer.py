...
if server.get_account_service().get_profile_from_email('tester@gmail.com') == None:
    context = {
        "ip": '127.0.0.1',
        "device_name": "TempDeviceName"
    }
    random_id = server.get_account_service().register('tester@gmail.com', 'test123', context)
